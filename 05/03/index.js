...
var car = function() {
    ...
    // Create the cabin
    var texCockpit = THREE.ImageUtils.loadTexture('img/cockpit.jpg', {}, function() {
    ...
    // Create Engine
    var texWheel = THREE.ImageUtils.loadTexture('img/wheel.jpg', {}, function() {
        renderer.render(scene, camera);
    });
    var geomWheel = new THREE.TorusGeometry(6, 3, 30, 30);
    var matWheel = new THREE.MeshLambertMaterial({
...
function createFloor() {
    var tex = THREE.ImageUtils.loadTexture('img/floor.jpg', {}, function() {
        renderer.render(scene, camera);
    });
    var geom = new THREE.PlaneGeometry(300, 300, 4, 4)
